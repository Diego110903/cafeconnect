<?php
    ...
    $db_user = "dbDiego"; // Nombre del Usuario para conectarnos a la Base de Datos
    $db_pass = "cafDB1109"; // Contraseña del Usuario de la Base de datos
    $db_name = "bd cafeconnect"; // Nombre de la Base de Datos
